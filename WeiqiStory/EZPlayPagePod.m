...
- (void) initStudyBoard2:(EZEpisodeVO*)epv
{
    ...
    CCMenuItemImage* quitButton = [CCMenuItemImage itemWithNormalImage:@"answer-button.png" selectedImage:@"answer-button.png"
                                                                 block:^(id sender){
...
- (void) createMainLayout:(EZEpisodeVO*)epv
{
    ...
    _mainFlexBoard = [[EZFlexibleBoard alloc] initWithBoard:@"chess-board-large.png" boardTouchRect:CGRectMake(27, 27, 632, 632) visibleSize:CGSizeMake(310, 310)];
    ...
    _mainFlexBoard.position = ccp(320/2, 244);
    ...
    CCMenuItemImage* studyButton = [CCMenuItemImage itemWithNormalImage:@"study-over-button.png" selectedImage:@"study-over-button.png"
                                                                  block:^(id sender){
                                                                      [[EZSoundManager sharedSoundManager] playSoundEffect:sndButtonPress];
                                                                      [weakSelf.player pause];
                                                                      [playButton setNormalSpriteFrame:weakSelf.playImg.displayFrame];
